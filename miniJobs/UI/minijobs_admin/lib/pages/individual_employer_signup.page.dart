...
class IndividualEmployerSignupPage extends StatefulWidget {
  const IndividualEmployerSignupPage({Key? key}) : super(key: key);

  @override
  State<IndividualEmployerSignupPage> createState() => _IndividualEmployerSignupPageState();
}

class _IndividualEmployerSignupPageState extends State<IndividualEmployerSignupPage> {
