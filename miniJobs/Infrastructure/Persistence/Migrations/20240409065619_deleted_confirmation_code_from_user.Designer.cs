...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240409065619_deleted_confirmation_code_from_user")]
    partial class deleted_confirmation_code_from_user
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ProposedAnswer", b =>
                {
                    b.HasOne("Domain.Entities.Question", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.ProposedAnswer", "QuestionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
